...
const { quotes, adverbs, verbs } = require("./data")
...
function moduleProject1() {
  ...
  const personParagaph = document.createElement('p')
  document.querySelector('.friends').appendChild(personParagaph)
  ...
  personParagaph.textContent = sentence
